...
const BlogIndex = () => {
  const data = useStaticQuery(graphql`
    query HomeQuery {
      image1: file(absolutePath: { regex: "/team1.jpg/" }) {
          childImageSharp {
        ...
        image2: file(absolutePath: { regex: "/team2.jpg/" }) {
          childImageSharp {
          fixed(width: 120, height: 120) {
            ...GatsbyImageSharpFixed
          }
        ...
        image3: file(absolutePath: { regex: "/team4.png/" }) {
          childImageSharp {
          fixed(width: 120, height: 120) {
            ...GatsbyImageSharpFixed
          }
        ...
        image4: file(absolutePath: { regex: "/team3.jpg/" }) {
          childImageSharp {
          fixed(width: 120, height: 120) {
            ...GatsbyImageSharpFixed
          }
