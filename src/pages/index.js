...
const BlogIndex = () => {
   const data = useStaticQuery(graphql`
    query HomeQuery {
      image1: file(absolutePath: { regex: "/team-2-800x800.jpg/" }) {
          childImageSharp {
        ...
        image2: file(absolutePath: { regex: "/team-3-800x800.jpg/" }) {
          childImageSharp {
          fixed(width: 50, height: 50) {
            ...GatsbyImageSharpFixed
          }
        ...
        image3: file(absolutePath: { regex: "/team-4-800x800.jpg/" }) {
          childImageSharp {
          fixed(width: 50, height: 50) {
            ...GatsbyImageSharpFixed
          }
        ...
        image4: file(absolutePath: { regex: "/team-1-800x800.jpg/" }) {
          childImageSharp {
          fixed(width: 50, height: 50) {
            ...GatsbyImageSharpFixed
          }
